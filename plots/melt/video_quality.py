...
if __name__ == "__main__":
    labels = ['ProCES-360', 'ProCES-360-a', 'ProCES-360-b', 'ProCES-360-c']
    data = [45173386370, 44357165608, 55063940552, 55133457070]
    ...
    format_draw_histogram(
        labels=labels,
        data=data,
        y_label_name='观看质量(bps)',
        x_label_name='',
        y_bottom=0,
        colors=colors,
        hatch_patterns=hatch_patterns,
        save_path='./video_quality_melt.png',
        bar_width=0.7,
